...
`pnpm runtime:check` builds the production runtime trees, Docker images, image
startup smoke checks, and rendered Kubernetes manifests.
...
| `.runtime` | Ignored production package output generated by `pnpm runtime:prepare` |
