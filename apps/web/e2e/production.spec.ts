...
test("field-policy page loads server data and supports create/update/read", async ({
  page,
}, testInfo) => {
  const assertHealthy = await expectHealthyDocument(page, "/app/settings/field-policies");
