...
`apps/web/smrt-packages.mjs` separates the canonical runtime SMRT package list
from the explicit consumer manifest providers. Vite consumes the packaged
...
the released public SMRT 0.49.8 cohort.
